...
const SpotifyQualitySelection = ({ 
  ...
  <div className='space-y-2 mt-2 relative'>
    <p className='text-cyan-400 text-[10px] font-black uppercase tracking-[0.15em] ml-1 opacity-80'>Select Output Quality</p>
    {options.length > 0 ? (
      ...
      <div className='text-center py-10 bg-white/5 rounded-2xl border border-dashed border-white/10'><p className='text-gray-500 text-sm italic'>No formats found for this link.</p></div>
    )}
  </div>
);
