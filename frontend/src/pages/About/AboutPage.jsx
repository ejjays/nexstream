  ...
  return (
    <motion.div
      ...
      <motion.section
        ...
        <h1
          className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-white">The Story of <span className="text-cyan-400">NexStream</span>
        </h1>
        <p className="text-gray-400 text-lg font-medium max-w-2xl mx-auto">A high-performance media bridge built from passion, persistence, and a
                    single mobile phone.
                  </p>
      </motion.section>
      <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {values.map((v, i) => (<GlassCard key={i} className="group">
          <div className="p-8">
      ...
      <motion.section
        ...
        <div
          className="absolute -top-24 -right-24 w-64 h-64 bg-cyan-500/10 blur-[100px] group-hover:bg-cyan-500/20 transition-all duration-700"></div>
        <div className="relative z-10 grid md:grid-cols-5 gap-8 items-start">
          <div className="md:col-span-3 space-y-6">
            <h2 className="text-3xl font-black text-white uppercase tracking-tighter">Hi, I'm <span className="text-cyan-400">EJ! <span className="animate-wave">👋</span></span>
            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed text-base">
              <p>I built NexStream with one clear goal:{" "}
                <span
                  className="text-white font-bold underline decoration-cyan-500/30 underline-offset-4">to make high-quality tools completely free for everyone
                                  </span>. I believe everyone deserves access to great media tools
                                without being hidden behind paywalls or cluttered with annoying
                                ads.
                              </p>
              <p>To be honest, I built this entire application using only my
                                mobile phone through Termux and Acode, as I don't have a
                                computer yet.
                              </p>
              <p>It has been a challenge, but I am very passionate about making
                                this work for you. Helping others is what keeps me going.
                              </p>
            </div>
          </div>
          <div
            className="md:col-span-2 space-y-6 bg-black/20 backdrop-blur-md border border-white/5 p-6 rounded-[2rem]">
            <h3 className="text-xs font-black text-cyan-400 uppercase tracking-widest">Support my Journey
                          </h3>
            <p className="text-xs text-gray-400 leading-relaxed">Your support helps me keep the servers running and allows me to
      ...
      <motion.section variants={itemVariants} className="space-y-12">
        <h2
          className="text-center text-sm font-black text-gray-500 uppercase tracking-[0.4em]">Technical Foundation
                  </h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
          {techStack.map((t, i) => (<div
            key={i}
      ...
      <motion.footer
        ...
        <div className="text-center">
          <p className="text-sm text-cyan-400 font-black uppercase tracking-widest">God bless & thank you for being part of this journey.
                      </p>
        </div>
        <button
