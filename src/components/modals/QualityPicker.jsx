...
import { X, Play, Download, Music, Video, Monitor, ChevronDown, Pencil, Check } from "lucide-react";
                    ...
                    >
                        ...
                        <div className="flex justify-between items-start gap-3">
                            <div className="flex-1">
                                 <h3 className="text-white font-bold text-lg leading-tight line-clamp-2" title={editedTitle}>
                                    {editedTitle}
                                 </h3>
                    ...
                    >
                             ...
                             <div className="flex gap-3">
                                <div className="space-y-1 flex-1">
                                    ...
                                    <input 
                                        ...
                                        placeholder={selectedFormat === "mp4" ? "Enter author" : "Enter artist"}
                                        className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-cyan-500/50 focus:bg-black/40 transition-all placeholder-gray-600"
                                    />
                                </div>
                                <div className="space-y-1 flex-1">
                        ...
                        <div className="flex gap-3 mt-2">
                            ...
                            <button 
                                ...
                                className="flex-1 bg-cyan-500 hover:bg-cyan-400 text-white py-3 rounded-xl font-bold transition-all shadow-lg shadow-cyan-500/20 text-sm flex items-center justify-center gap-2"
                            >
                                <Check size={16} />
                                Save Changes
                            </button>
