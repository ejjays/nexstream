  ...
  return (
    <div className="w-full flex flex-col gap-10 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {coreSystems.map(
          (system, idx) => (<GlassCard key={idx} className="group relative overflow-hidden">
            <div
            ...
            <div className="p-8 flex flex-col h-full">
              ...
              <ul className="space-y-4 mt-auto">
                {system.points.map((point, pIdx) => (<li
                  key={pIdx}
      ...
      <section
        className="bg-black/40 backdrop-blur-xl border border-cyan-500/20 p-8 rounded-[2rem] shadow-inner relative overflow-hidden">
        <div className="flex items-center gap-3 mb-6">
          <span className="text-2xl">🔬</span>
          <h2 className="text-xl font-black text-cyan-400 uppercase tracking-tighter">Resilient Muxing Engine
                      </h2>
        </div>
      ...
      <section className="mt-4">
        <GlassCard className="group relative overflow-hidden">
          <div
            className="absolute inset-0 bg-gradient-to-r from-cyan-500/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
          <div
