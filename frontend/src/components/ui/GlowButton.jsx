  ...
  return (
    <>
      ...
      <button
        ...
        {}
        <div
          className="absolute inset-0 z-[3] rounded-[24px] pointer-events-none shadow-[inset_0_3px_12px_rgba(0,140,175,0.671),inset_0_-3px_4px_rgba(157,0,209,0.8)]" />
        <div
          className="relative overflow-hidden rounded-[24px] min-w-[132px] py-3 px-6">
