                ...
                <div className="flex items-center gap-4 relative z-10">
                  <div className="relative shrink-0">
                    <motion.div 
                      ...
                      className={`w-14 h-14 rounded-full overflow-hidden border border-white/20 p-1 shadow-lg transition-all duration-700 ${hasPreview ? 'bg-cyan-500/10' : 'bg-white/10'}`}
                    >
