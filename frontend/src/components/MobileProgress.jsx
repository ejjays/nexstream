...
const MobileStatusCard = ({ 
  ...
  return (
    <div className='lg:hidden w-full max-w-md mt-4 flex items-center justify-center'>
          ...
          >
            <AnimatePresence mode="wait">
              {error ? (
                ...
                /* ORIGINAL SUCCESS DESIGN (EMERALD) */
                <motion.div
                  key="success"
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
