      ...
      <div className="container">
        <div className="error-illustration">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 50 500 400">
            <g className="shelf">
              <path d="M60.2 311.4c1 0 39.3 19.3 39.3 19.3h372.1l-30-31.7z" style={{opacity: '.12', fill: '#FFFFFF'}} />
              <path d="M439.7 311.4H60.1a4 4 0 0 1-4-4V301a4 4 0 0 1 4-4h379.6a4 4 0 0 1 4 4v6.4a4 4 0 0 1-4 4" style={{fill: '#0891b2'}} />
              <path d="M60.2 297a4 4 0 0 0-4 3.8 4 4 0 0 0 4 3.8h379.4a4 4 0 0 0 4-3.8 4 4 0 0 0-4-3.8z" style={{fill: '#22d3ee'}} />
              <path d="M63.3 301.8h372.1c1.5 0 1.5-2.3 0-2.3H63.3c-1.5 0-1.5 2.3 0 2.3" style={{fill: '#67e8f9'}} />
            </g>
            <g className="shelf">
              <path d="M57.3 394.9c1.1 0 39.3 19.2 39.3 19.2h372.2l-30-31.7z" style={{opacity: '.12', fill: '#FFFFFF'}} />
              <path d="M439.7 394H60.1a4 4 0 0 1-4-4v-6.4a4 4 0 0 1 4-4h379.6a4 4 0 0 1 4 4v6.4a4 4 0 0 1-4 4" style={{fill: '#0891b2'}} />
              <path d="M60.2 379.6a4 4 0 0 0-4 3.8 4 4 0 0 0 4 3.8h379.4a4 4 0 0 0 4-3.8 4 4 0 0 0-4-3.8z" style={{fill: '#22d3ee'}} />
              <path d="M63.3 384.4h372.1c1.5 0 1.5-2.3 0-2.3H63.3c-1.5 0-1.5 2.3 0 2.3" style={{fill: '#67e8f9'}} />
            </g>
            <g id="cat">
              <g id="cat-tail">
              ...
              <path id="cat-hand" d="M199 217.7s-12.3 14.3-21.8 4.8-.7-42.2-21-52.4c-20.5-10.2-33.4 13-26 16.4 7.6 3.4 12.3-.7 12.3-.7s-.7 10.9 10.2 6.8 8.9 0 8.9 0a91 91 0 0 0 2 22.4c1.3 5.8 3.1 11.6 6.3 16.7a26 26 0 0 0 5.6 6.3c2.9 2.3 5.7 2.2 8.8 3.7q-1.4 1.4-3 2c7.7 1.5 15.5-2.1 22.6-5.7 5.1-2.5 9-6 11.4-11.4 2.7-6.1-6.8-18.4-16.3-8.9" style={{fill: '#1e293b'}} />
              <path id="cat-hand-highlight" d="M199 217.7s-12.3 14.3-21.8 4.8l-1-1.2c.5 2.9 2 6.7 6.4 8.3 7.3 2.7 15.1-2.4 15.1-2.4l-3.2 4.9s8-4 9.4-2.7c1.2 1.1-5.7 7.2-2.6 10l2.6-1.4c5.1-2.5 9-6 11.4-11.4 2.7-6.1-6.8-18.4-16.3-8.9" style={{fill: '#67e8f9', opacity: 0.6}} />
              <path id="cat-hand" d="M175.3 224.8l3.5-1q-.8-.5-1.6-1.3c-9.5-9.5-.7-42.2-21-52.4-20.5-10.2-33.4 13-26 16.4 7.6 3.4 12.3-.7 12.3-.7s-.7 10.9 10.2 6.8c1.8-.7 2.4-.8 4.2 0 1.7.8 2.5 2.7 3 4.5 2 5.8 2.4 12 3.7 18q1 4.5 2.6 8.9c.8 2.2 3.9 6 4 8.2l-1-12.5c.4 1.4 6.1 5.1 6.1 5.1" style={{fill: '#67e8f9'}} />
