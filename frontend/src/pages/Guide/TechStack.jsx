        ...
        <div className='relative p-12 rounded-[3rem] bg-[#020617]/60 backdrop-blur-3xl border border-cyan-500/20 text-center overflow-hidden isolation-auto transform-gpu'>
          ...
          <div className='relative z-10 space-y-6'>
            ...
            <p className='text-lg text-cyan-50 leading-relaxed max-w-2xl mx-auto font-medium'>
              ...
              <a href="https://github.com/yt-dlp/yt-dlp" target="_blank" rel="noopener noreferrer" className='text-white font-black underline decoration-cyan-400 decoration-2 underline-offset-8 bg-cyan-400/10 px-2 py-0.5 rounded-md hover:bg-cyan-400/20 transition-colors'>
                yt-dlp
              </a>{' '}
              and{' '}
              <a href="https://github.com/FFmpeg/FFmpeg" target="_blank" rel="noopener noreferrer" className='text-white font-black underline decoration-cyan-400 decoration-2 underline-offset-8 bg-cyan-400/10 px-2 py-0.5 rounded-md hover:bg-cyan-400/20 transition-colors'>
                FFmpeg
              </a>
