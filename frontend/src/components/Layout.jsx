  ...
  return (
    <div className="flex flex-col min-h-dvh w-full relative overflow-hidden">
      ...
      <footer className="px-2 pb-[calc(env(safe-area-inset-bottom)+1rem)] shrink-0 relative flex flex-col items-center justify-center gap-4">
        ...
        <SocialMedia />
        <div className="absolute left-2 bottom-[calc(env(safe-area-inset-bottom)+0.5rem)] sm:left-4 sm:bottom-4">
          <DocsButton />
        </div>
        <div className="absolute right-2 bottom-[calc(env(safe-area-inset-bottom)+0.5rem)] sm:right-4 sm:bottom-4">
          <SupportButton />
        </div>
      </footer>
    </div>
