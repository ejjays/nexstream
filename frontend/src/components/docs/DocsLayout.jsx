...
const DocsLayout = ({ children }) => {
  return (
    <div className='flex min-h-screen w-full bg-[#030014] overflow-x-hidden selection:bg-cyan-500/30 selection:text-cyan-200 relative'>
      ...
      <main className='flex-1 lg:pl-72 min-h-screen relative z-10 px-6 py-12 md:px-12 md:py-16 scroll-smooth'>
